...
{
  console.log('onLoad', 'into - 1');
}), _defineProperty(_data$onLoad$methods$, "onShow", function onShow()

{
  console.log('onShow', 'into - 2');
}), _defineProperty(_data$onLoad$methods$, "onReady", function onReady()

{
  console.log('onReady', 'into - 3');
}), _defineProperty(_data$onLoad$methods$, "onHide", function onHide()

{
  console.log('onHide', '离开当前页面');
}), _defineProperty(_data$onLoad$methods$, "onUnload", function onUnload()

{
  console.log('onUnload');
}), _defineProperty(_data$onLoad$methods$, "onPullDownRefresh", function onPullDownRefresh()

{
  console.log('onPullDownRefresh', 'onPullDownRefresh');
  this.getlist();
}), _defineProperty(_data$onLoad$methods$, "onPageScroll", function onPageScroll()

{
  console.log('onPageScroll');
}), _defineProperty(_data$onLoad$methods$, "onReachBottom", function onReachBottom()

{
  console.log('onReachBottom');
}), _defineProperty(_data$onLoad$methods$, "onShareAppMessage", function onShareAppMessage()

{
  console.log('onShareAppMessage');
}), _defineProperty(_data$onLoad$methods$, "onTabItemTap", function onTabItemTap()
